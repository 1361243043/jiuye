...
<title>我的简历 - 个人会员中心 - 临沂信息港人才网</title>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">修改企业信息</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" enctype='multipart/form-data'><tr>
                ...
                <td>
				<div>
				<input name="e_name" type="text" value='<?php echo ($data["e_name"]); ?>' style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
                    <span style="color:#666666"></span>
					</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>企业图片：</td>
                <td>
				<div>
              ...
              <tr>
                ...
                <td width="836"><input name="e_tel" type="text" value='<?php echo ($data["e_tel"]); ?>' style="height:30px" class="input_text_200" id="companyname" maxlength="40" /></td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>企业邮箱：</td>
                <td width="836"><input name="e_mil" type="text" value='<?php echo ($data["e_mil"]); ?>' style="height:30px" class="input_text_200" id="companyname" maxlength="40" /></td>
              </tr>
             
              <tr>
                <td width="242" height="23" align="right" valign="top">企业简介：</td>
                <td><textarea name="e_intro" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
                	<?php echo ($data["e_intro"]); ?>
                </textarea>
                  <br />
                 请简要说明公司性质、规模、业务、发展历程等</td>
              </tr>
			     <tr>
                <td width="242" height="23" align="right" valign="top">企业地址：</td>
                <td><textarea name="achievements"  id="achievements"  style="width:350px; height:90px; line-height:160%; font-size:12px;"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
                	<?php echo ($data["e_add"]); ?>
                </textarea>
                  <br /></td>
              </tr>
