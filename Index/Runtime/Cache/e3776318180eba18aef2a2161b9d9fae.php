...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="__URL__/qiye">企业中心</a>&nbsp;>>&nbsp;修改密码
</div>
          ...
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
			...
			<form id="Form1" name="Form1" method="post" action="" enctype='multipart/form-data'><tr>
			 ...
			 <tr>
                ...
                <td>
				<div>
				<input name="epwd" type="password" id="jmima" style="height:30px" class="input_text_200 date_input" maxlength="18" />
              ...
              <tr>
                ...
                <td>
				<div>
				<input name="e_pwd" type="password"  style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
