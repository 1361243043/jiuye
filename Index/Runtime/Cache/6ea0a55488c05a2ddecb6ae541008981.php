...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="__URL__/geren">个人中心</a>&nbsp;>>&nbsp;修改密码
</div>
        ...
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
			...
			<form id="Form1" name="Form1" method="post" action="" enctype='multipart/form-data'><tr>
			 ...
			 <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>旧密码：</td>
                <td>
				<div>
				<input name="upwd" type="password" id="jmima" style="height:30px" class="input_text_200 date_input" maxlength="18" />
                    <span style="color:#f00" id='jmimas' >密码填写长度必须为8位</span>
					</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td>
				<div>
				<input name="u_pwd" type="password"  style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
                    <span style="color:#f00">密码填写长度必须为8位</span>
					</div>
					</td>
              </tr>
...
<script type='text/javascript'>
	$('#jmima').blur(
		function(){
			$pwd=$("input[id='jmima']").val()
			$.get('__URL__/jmima',{pwd:$pwd},function(data){
				$('#jmimas').html(data);
			});
		}		
	);
