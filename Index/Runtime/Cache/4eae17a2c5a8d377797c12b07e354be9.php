...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">捐赠</a>&nbsp;>>&nbsp;查看具体信息</div>
          ...
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["d_name"]); ?></span>
					</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>捐赠金额 ：</td>
                <td>
				<div>
				
				
                    <span style="color:#666666"><?php echo ($data["d_money"]); ?></span>
						</div>
					</td>
              </tr>
              
               <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>捐赠类型：</td>
                <td>
				<div>
				
				
                    <span style="color:#666666"><?php echo ($data["t_type"]); ?></span>
						</div>
					</td>
              </tr>
              
               <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>捐赠时间：</td>
                <td>
				<div>
				
				
                    <span style="color:#666666"><?php echo ($data["d_time"]); ?></span>
						</div>
					</td>
              </tr>
               ...
               <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["d_tel"]); ?></span>
						</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <a href='__URL__/juanzeng'><input type='button' value='返回上一级'  class="user_submit" /></a>                  
                &nbsp;
