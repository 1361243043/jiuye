...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">企业中心</a>&nbsp;>>&nbsp;修改招聘信息
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">修改招聘信息</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
                ...
                <td>
				<div>
				<input name="i_name" type="text"  value='<?php echo ($data["i_name"]); ?>' style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
              ...
              <tr>
				...
				<input name="i_num" type="text" value='<?php echo ($data["i_num"]); ?>' class="input_text_200 date_input" id="endtime" maxlength="18"  style="height:30px" />
                    <span style="color:#666666"></span>
						</div>
					</td>
              </tr>
              <tr>
                ...
                <td width="836">
                	<?php if($data["i_reward"] == '是' ): ?>是<input type='radio' name='i_reward' checked='checked' value='是' />
                		否<input type='radio' name='i_reward' value='否' />
                	<?php else: ?>
                		是<input type='radio' name='i_reward'  value='是' />
                		否<input type='radio' name='i_reward' checked='checked' value='否' /><?php endif; ?>
                </td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>工作经验：</td>
                <td width="836">
                	<?php if($data["i_jinyan"] == '需要' ): ?>需要<input type='radio' name='i_jinyan' checked='checked' value='需要' />
                		不需要<input type='radio' name='i_jinyan' value='不需要' />
                	<?php else: ?>
                		需要<input type='radio' name='i_jinyan'  value='需要' />
                		不需要<input type='radio' name='i_jinyan' checked='checked' value='不需要' /><?php endif; ?>         
                </td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>性别要求：</td>
                <td width="836">
                	<?php if($data["i_sexyq"] == '不限' ): ?>不限<input type='radio' name='i_sexyq' checked='checked' value='不限' />
                		男<input type='radio' name='i_sexyq' value='男' />
                		女<input type='radio' name='i_sexyq' value='女' />
                	<?php elseif($data["i_sexyq"] == '男' ): ?>
                		不限<input type='radio' name='i_sexyq'  value='不限' />
                		男<input type='radio' name='i_sexyq' checked='checked' value='男' />
                		女<input type='radio' name='i_sexyq' value='女' />
                	<?php else: ?>
                		不限<input type='radio' name='i_sexyq'  value='不限' />
                		男<input type='radio' name='i_sexyq'  value='男' />
                		女<input type='radio' name='i_sexyq' checked='checked' value='女' /><?php endif; ?>
               ...
               <tr>
                ...
                <td width="836">
                	<input type='text' name='i_tel' value='<?php echo ($data["i_tel"]); ?>' />
                </td>
              </tr>
              ...
              <tr>
				...
				<input name="i_time" type="text" value='<?php echo ($data["i_time"]); ?>' class="input_text_200 date_input" id="endtime" maxlength="18"  style="height:30px" />
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <input type="submit" name="sub" value="确认修改"   class="user_submit"/>                  
               					  <a href='__URL__/szhaopin'><input type='button' value='返回上一级'  class="user_submit" /></a>
