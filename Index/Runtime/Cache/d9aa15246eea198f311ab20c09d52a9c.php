...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">就业服务</a>&nbsp;>>&nbsp;查看具体信息</div>
        ...
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				 ...
				 <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>学生姓名：</td>
                <td>
				<div>
				
                    <span style="color:#666666"><?php echo ($data["s_name"]); ?></span>
					</div>
					</td>
              </tr>
              <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_city"]); ?></span>
						</div>
					</td>
              </tr>
               ...
               <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_company"]); ?></span>
						</div>
					</td>
              </tr>
              
               <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>福利：</td>
                <td>
				<div>
				
				
                    <span style="color:#666666"><?php echo ($data["s_requite"]); ?></span>
						</div>
					</td>
              </tr>
              ...
              <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><img src='__PUBLIC__/Images/<?php echo ($data["s_img"]); ?>' width='100px' /></span>
						</div>
					</td>
              </tr>
               ...
               <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_time"]); ?></span>
						</div>
					</td>
              </tr>
               ...
               <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_now"]); ?></span>
						</div>
					</td>
              </tr>
              ...
              <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_money"]); ?></span>
						</div>
					</td>
              </tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_gangwei"]); ?></span>
						</div>
					</td>
              </tr>
               ...
               <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["s_help"]); ?></span>
						</div>
					</td>
              </tr>
              
              <tr>
                <td width="242" height="23" align="right" valign="top">工作历程：</td>
                <td><textarea  readonly='readonly' id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
                	<?php echo ($data["s_progerss"]); ?>
                </textarea>
                  <br />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <a href='__URL__/jiuye'><input type='button' value='返回上一级'  class="user_submit" /></a>                  
                &nbsp;
