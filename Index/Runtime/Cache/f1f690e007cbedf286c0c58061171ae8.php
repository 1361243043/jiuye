...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="">聘人才</a>
</div>
    ...
    <div class="show link_lan">
			...
			<div class="link_bku">
				岗位:<select name='post'>
					...
					<?php if(is_array($post)): $i = 0; $__LIST__ = $post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["aj_post"]); ?>'><?php echo ($vo["aj_post"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
				目标薪金:<select name='money'>
					<option value=''>--请选择--</option>
					<?php if(is_array($money)): $i = 0; $__LIST__ = $money;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["aj_money"]); ?>'><?php echo ($vo["aj_money"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			...
			<div class="clear"></div>
			 <table class="recommend-jobs" width="100%" border="0" cellspacing="0" cellpadding="6" >
			 	...
			 	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td >
						<dl>
      						<dt><?php echo ($vo["aj_name"]); ?></dt>
      						<dd><span>求</span> <a href="" target="_blank"><span style="color:#ed008c"><?php echo ($vo["aj_post"]); ?></span></a> 
         					</dd>
   					 	</dl>
					</td>
					<td >
						<dl>
      						<dt>目标薪金</dt>
      						<dd> <a href="" target="_blank"><span style="color:#ed008c"><?php echo ($vo["aj_money"]); ?></span></a>|<a href='__URL__/see/id/<?php echo ($vo["aj_id"]); ?>'>&gt;&gt;更多</a>
         					</dd>
   					 	</dl>
					</td>
