...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="">就业服务</a>
</div>
...
<div class="company-show">
  <div class="left">
    <div class="show link_lan" style="width:680px">
			...
			<div class="link_bku">
				学生名称:<input name="name" type="text"  class="input_text_200 date_input" id="endtime" maxlength="18"  style="height:21px;width:70px" />
				城市:
					<select name='city'>
				...
				职位:
					<select name='gangwei'>
						<option value=''>--请选择--</option>
						<?php if(is_array($gangwei)): $i = 0; $__LIST__ = $gangwei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["s_gangwei"]); ?>'><?php echo ($vo["s_gangwei"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
			...
			<div class="clear"></div>
			 <table class="recommend-jobs" width="100%" border="0" cellspacing="0" cellpadding="6" >
			  ...
			  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td >
						<dl>
      						<dt><?php echo ($vo["s_name"]); ?></dt>
      						<dd><span>职</span> <a href="" target="_blank"><span style="color:#ed008c"><?php echo ($vo["s_gangwei"]); ?></span></a> 
         					</dd>
   					 	</dl>
					</td>					
					<td >
						<dl>
      						<dt> 所在城市</dt>
      						<dd> <a href="" target="_blank"><span style="color:#ed008c"><?php echo ($vo["s_city"]); ?></span></a>|<a href='__URL__/see/id/<?php echo ($vo["s_id"]); ?>'>&gt;&gt;更多</a>
         					</dd>
   					 	</dl>
					</td>
