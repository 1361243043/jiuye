...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">个人中心</a>&nbsp;>>&nbsp;个人建议
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">个人建议</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				 ...
				 <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>建议人：</td>
                <td>
				<div>
				<input name="a_name" type="text"  style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
                    <span style="color:#666666"></span>
					</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>建议级别：</td>
                <td>
				<div>
				一般<input type='radio' name='a_grade' value='一般' />
				 重要<input type='radio' name='a_grade' value='重要' />
                    <span style="color:#666666"></span>
						</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>建议时间：</td>
                <td width="836">
                	<input type='text' name='a_time' />
                	<span style="color:#666666">格式必须为2014-09-09</span>
                </td>
              </tr>
              ...
              <tr>
                <td width="242" height="23" align="right" valign="top">建议内容：</td>
                <td><textarea name="a_content" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
              ...
              <tr>
                ...
                <td><textarea name="a_other" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <input type="submit" name="sub" value="提交"   class="user_submit"/>                  
                &nbsp;
