...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">个人中心</a>&nbsp;>>&nbsp;修改求职
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">修改求职</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				 ...
				 <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>求职人：</td>
                <td>
				<div>
				<input name="aj_name" type="text"  value='<?php echo ($data["aj_name"]); ?>' style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
                    <span style="color:#666666"></span>
					</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>求职岗位：</td>
                <td>
				<div>
				
				<input name="aj_post" type="text" value='<?php echo ($data["aj_post"]); ?>' class="input_text_200 date_input" id="endtime" maxlength="18"  style="height:30px" />
                    <span style="color:#666666"></span>
						</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td width="836">
                	<input type='text' name='aj_tel' value='<?php echo ($data["aj_tel"]); ?>' />
                </td>
              </tr>
              
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>目标薪金：</td>
                <td width="836">
                	<input type='text' name='aj_money' value='<?php echo ($data["aj_money"]); ?>' />
                </td>
              </tr>
             
              
              <tr>
                <td width="242" height="23" align="right" valign="top">技术特长：</td>
                <td><textarea name="aj_techang" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
                	<?php echo ($data["aj_techang"]); ?>
                </textarea>
                  <br />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td><textarea name="aj_remaks" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
                	<?php echo ($data["aj_remaks"]); ?>
                </textarea>
                  <br />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <input type="submit" name="sub" value="确认修改"   class="user_submit"/>                  
                				<a href='__URL__/sqiuzhi'><input type='button' value='返回上一级'  class="user_submit" /></a>                  
