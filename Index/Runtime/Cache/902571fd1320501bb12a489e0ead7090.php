...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="__URL__/geren">个人中心</a>&nbsp;>>&nbsp;填写密保
</div>
          ...
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
			...
			<form id="Form1" name="Form1" method="post" action="" enctype='multipart/form-data'><tr>
			 ...
			 <tr>
                ...
                <td>
				<div>
				<input type='hidden' name='m_user' value='<?php echo ($uname); ?>'>
				<input name="m_cname" type="text" id="jmima" style="height:30px" class="input_text_200 date_input" maxlength="18" />
              ...
              <tr>
                ...
                <td>
				<div>
				<input name="m_fname" type="text"  style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <input type="submit" name="sub" value="添加"   class="user_submit"/>
