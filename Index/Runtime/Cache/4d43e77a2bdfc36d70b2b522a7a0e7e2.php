    ...
    <form  method="post" action="">
      <input name="member_type" type="hidden" id="member_type" value="2" />
	   <div class="reg-box">
        <dl>
           <dt>用户类型：</dt>
		                       <dd><strong>个人用户注册</strong><span>（切换至 <a href="__URL__/qiye">企业用户</a> 注册）</span></dd>
		                     
                     <dt>用户账号：</dt>
          <dd>
            <input name="u_name" id="username" value=""  type="text" class="input-1" autocomplete="off" size="28" />
           <br/>
           <span style="color:#f00">请以s开头 填写手机号</span>
          </dd>
          <dt>登录密码：</dt>
          <dd>
            <input name="u_pwd" id="password" value="" type="password" onBlur="AuthPasswd(this.value);" onKeyUp="AuthPasswd(this.value);" class="input-1" size="28" />
            <br/>
          ...
          <dt>重复密码：</dt>
          <dd>
            <input name="upwd" id="password2" value="" type="password" class="input-1" size="28" />
            <br/>
            <span style="color:#f00;">密码请填写8位数</span>
          </dd>
           ...
           <dt>联系方式：</dt>
          <dd>
            <input name="u_tel" id="password" value="" type="text" onBlur="AuthPasswd(this.value);" onKeyUp="AuthPasswd(this.value);" class="input-1" size="28" />
          </dd>
