...
<div class="nav-main">
  <div class="nav-bd">
    <ul>		<li><a href="__APP__/Index/index/id/1" ><span>首  页</span></a></li>		<li><a href="__URL__/qiye" target="_blank" id="cur"><span>企业中心</span></a></li>		<li><a href="__URL__/zhaopin" target="_blank" ><span>聘人才</span></a></li>		<li><a href="__URL__/juanzeng" target="_self" ><span>捐赠申请</span></a></li>		<li><a href="__URL__/huiyuan" target="_self" ><span>会员申请</span></a></li>		<li><a href="__URL__/geren" target="_self" ><span>个人建议</span></a></li>		<li><a href="__URL__/updateqiye/id/<?php echo ($data["e_id"]); ?>" target="_blank" ><span>修改信息</span></a></li>	   <li><a href="__URL__/mibao" target="_blank" ><span>填写密保</span></a></li>	      </ul>
    <div class="tel">投诉电话：0538-8123450</div>
  </div>
</div><div class="page_location link_bk">
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="http://job.ly169.cn/jobs/">招聘信息</a>&nbsp;>>&nbsp;山东银河机械化工有限公司
</div>
<div class="company-show-topnav">
			  <div class="company_license1" title="营业执照已验证" >&nbsp;&nbsp;&nbsp;</div>
  <div class="topcomname">
  <h1><?php echo ($data["e_name"]); ?></h1>
  ...
  <div class="snav">
		<a href="http://job.ly169.cn/company/company-show.php?id=54810" class="selected">公司介绍</a>
		<a href="__URL__/szhaopin" >查看招聘</a>
		<a href="__URL__/updatemima/id/<?php echo ($data["e_id"]); ?>" >密码修改</a>
...
<div class="company-show">
  <div class="left">
    <div class="show link_lan">
			 ...
			 <div class="logo"><img src="__PUBLIC__/Images/<?php echo ($data["e_img"]); ?>" border="0" /></div>
			 
			 <div class="item">

			 <ul class="link_bku">
			<li>企业邮箱：<?php echo ($data["e_mil"]); ?></li>
			<li>企业账号：<?php echo ($data["e_user"]); ?></li>
			<li></li>
			</ul>
			</div>
			<div class="clear"></div>
			 
			 	         <div class="title"><strong>公司简介</strong>
			 	         </div>
			 ...
			 <div class="title"><strong>公司位置</strong>
			 </div>
  ...
  <div class="right">
		  <div class="txtbox">
				  ...
				  <div class="qrcode"><img src="/plus/url_qrcode.php?url=http://job.ly169.cn/company/company-show.php?id=54810" alt="山东银河机械化工有限公司 - 二维码" /></div>	  
		    <div class="txt">
					  <ul class="link_bku">
						<li>企业性质：民营企业</li>
						<li>所属行业：<a href="http://job.ly169.cn/jobs/jobs-list.php?trade=29" target="_blank">生产制造加工</a></li>
						
						<li>公司规模：<a href="http://job.ly169.cn/jobs/jobs-list.php?scale=81" target="_blank">50-200人</a></li>
