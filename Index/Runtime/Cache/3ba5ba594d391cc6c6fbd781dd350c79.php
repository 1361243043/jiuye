      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">申请会员只需填写如下信息</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
                ...
                <td>
				<div>
                    <span style="color:#666666">有多种会员类型供您选择</span>
					</div>
					</td>
              </tr>
                ...
                <td>
				<div>
                    <span style="color:#666666">填写您的联系方式,方便及时通知您重要信息</span>
					</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td><textarea name="d_remarks" id="companyprofile"  readonly='readonly'  style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
                	可填写您对本网站会员管理的看法
                </textarea>
                  <br />
                </td>
              ...
              <tr>
                ...
                <a href='__APP__/Enterprise/huiyuan'  ><input type='button' value='立即去注册' class="user_submit" /></a>
                </br></br>
                <a href='__URL__/jiuye'  ><input type='button' value='下次再说' class="user_submit" /></a>
