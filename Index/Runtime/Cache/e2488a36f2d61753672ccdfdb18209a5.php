...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">企业中心</a>&nbsp;>>&nbsp;查看我的招聘</div>
        ...
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				 ...
				 <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>招聘公司：</td>
                <td>
				<div>
				
                    <span style="color:#666666"><?php echo ($data["i_name"]); ?></span>
					</div>
					</td>
              </tr>
              <tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["i_num"]); ?></span>
						</div>
					</td>
              </tr>
              
               <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>是否悬赏：</td>
                <td>
				<div>
				
				
                    <span style="color:#666666"><?php echo ($data["i_reward"]); ?></span>
						</div>
					</td>
              </tr>
              
               <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>公司地址：</td>
                <td>
				<div>
				
				
                    <span style="color:#666666"><?php echo ($data["i_dizhi"]); ?></span>
						</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td width="836">
                	 <span style="color:#666666"><?php echo ($data["i_jinyan"]); ?></span>
              ...
              <tr>
                ...
                <td width="836">
                	 <span style="color:#666666"><?php echo ($data["i_sexyq"]); ?></span>
               ...
               <tr>
                ...
                <td width="836">
                	 <span style="color:#666666"><?php echo ($data["i_tel"]); ?></span>
               ...
               <tr>
                ...
                <td width="836">
                	 <span style="color:#666666"><?php echo ($data["i_time"]); ?></span>
                	
                </td>
              </tr>
              
              <tr>
                <td width="242" height="23" align="right" valign="top">招聘介绍：</td>
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <a href='__URL__/qiye'><input type='button' value='返回上一级'  class="user_submit" /></a>                  
                               	<a href='__URL__/updatezp/id/<?php echo ($data["i_id"]); ?>'><input type='button' value='修改我的招聘'  class="user_submit" /></a>
                               	<a href='__URL__/deletezp/id/<?php echo ($data["i_id"]); ?>'><input type='button' value='删除'  class="user_submit" /></a>			 				
                  <br /></td>
              </tr></form>
            </table>
			</td>
