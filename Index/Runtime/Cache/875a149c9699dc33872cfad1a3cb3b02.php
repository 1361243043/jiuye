...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">个人中心</a>&nbsp;>>&nbsp;捐赠申请
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">申请捐赠</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				 ...
				 <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>捐赠人：</td>
                <td>
				<div>
				<input name="d_name" type="text"  style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
                    <span style="color:#666666"></span>
					</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>金额：</td>
                <td>
				<div>
				
				<input name="d_money" type="text" class="input_text_200 date_input" id="endtime" maxlength="18"  style="height:30px" />
                    <span style="color:#666666"></span>
						</div>
					</td>
              </tr>
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>捐赠对象：</td>
                <td width="836">
                	<select name='t_id'>
                		<option value='<?php echo ($type[0]["t_id"]); ?>'>--请选择--</option>
                		<?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["t_id"]); ?>'><?php echo ($vo["t_type"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                	</select>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><textarea name="d_remarks" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
