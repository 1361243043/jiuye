...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">个人中心</a>&nbsp;>>&nbsp;个人信息修改
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">修改个人信息</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" enctype='multipart/form-data'><tr>
              ...
              <tr>
                ...
                <td width="836"><input name="u_tel" type="text" value='<?php echo ($data["u_tel"]); ?>' style="height:30px" class="input_text_200" id="companyname" maxlength="40" /></td>
              </tr>
             
             
             	  
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>用户昵称：</td>
                <td width="836"><input name="u_nicheng" type="text" value='<?php echo ($data["u_nicheng"]); ?>' style="height:30px" class="input_text_200" id="companyname" maxlength="40" /></td>
              </tr>
              
              <tr>
                <td width="242" height="23" align="right" valign="top">个性签名：</td>
                <td><textarea name="u_gexin" id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
