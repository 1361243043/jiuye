...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">个人中心</a>&nbsp;>>&nbsp;查看我的求职
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">查看求职</span> <span style="color: #666666"></span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
				...
				<div>
                    ...
                    <span style="color:#666666"><?php echo ($data["aj_name"]); ?></span>
					</div>
					</td>
              </tr>
              <tr>
				...
				<span style="color:#666666"><?php echo ($data["aj_post"]); ?></span>
						</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td width="836">
                	<span style="color:#666666"><?php echo ($data["aj_tel"]); ?></span>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td width="836">
                	<span style="color:#666666"><?php echo ($data["aj_money"]); ?></span>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td><textarea name="aj_techang" readonly='redonly' id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
              ...
              <tr>
                ...
                <td><textarea name="aj_remaks" readonly='readonly' id="companyprofile"   style="width:350px; height:90px;line-height:160%; font-size:12px"  onpropertychange="if(this.value.length>200){this.value=this.value.slice(0,200)}">
              ...
              <tr>
                ...
                <td height="60"  >
				 				...
				 				<a href='__URL__/geren'><input type='button' value='返回上一级'  class="user_submit" /></a>                  
                               	<a href='__URL__/updateqz/id/<?php echo ($data["aj_id"]); ?>'><input type='button' value='修改我的求职'  class="user_submit" /></a>
                               	<a href='__URL__/deleteqz/id/<?php echo ($data["aj_id"]); ?>'><input type='button' value='删除'  class="user_submit" /></a>			 				
