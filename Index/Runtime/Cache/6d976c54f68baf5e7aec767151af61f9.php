...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="__URL__/geren">个人中心</a>&nbsp;>>&nbsp;查看密保
</div>
			...
			<form id="Form1" name="Form1" method="post" action="" enctype='multipart/form-data'><tr>
			 ...
			 <tr>
				...
				<div>
                    ...
                    <span style="color:#f00;font-size:18px" id='jmimas' ><?php echo ($data["m_cname"]); ?></span>
					</div>
					</td>
              </tr>
              ...
              <tr>
				...
				<div>
                    ...
                    <span style="color:#f00;font-size:18px"><?php echo ($data["m_fname"]); ?></span>
					</div>
					</td>
              </tr>
              ...
              <tr>
                ...
                <td height="60"  >
				 				 ...
				 				 <a href='__URL__/umibao/id/<?php echo ($data["m_id"]); ?>'><input type='button' value='修改' class="user_submit" /></a>
				 				 <a href='__URL__/dmibao/id/<?php echo ($data["m_id"]); ?>'><input type='button' value='删除' class="user_submit" /></a>
