...
当前位置：<a href="__APP__/Index/index/id/1">首页</a>&nbsp;>>&nbsp;<a href="__URL__/geren">个人注册</a>&nbsp;>>&nbsp;填写昵称
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">昵称填写</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
              ...
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>昵称：</td>
                <td width="836">
                	<input type='text' name='u_nicheng' class="input_text_200 date_input" id="endtime" style="height:30px" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <input type="submit" name="sub" value="确定"   class="user_submit"/>                  
