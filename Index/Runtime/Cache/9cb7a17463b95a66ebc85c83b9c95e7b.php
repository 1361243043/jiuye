      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">找回密码</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
              ...
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>用户账号：</td>
                <td width="836">
              ...
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>初中班主任姓名：</td>
                <td width="836">
              ...
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>新密码：</td>
                <td width="836">
                	<input type='password' name='pwd' />
                	<span style="color:#f00;font-size:20px">密码请填写8位数</span>
                </td>
              </tr>
              
              <tr>
                <td width="242" height="23" align="right" valign="top"><strong  style="color:#FF0000">*</strong>确认新密码：</td>
                <td width="836">
              ...
              <tr>
                ...
                <td height="60"  >
				 				 <input type="submit" name="sub" value="保存"   class="user_submit"/>                  
                &nbsp;			
...
<script type='text/javascript'>
	$('#huiyuan').change(
		function(){
			...
			//将id号传到所请求的页面
			$.get('__URL__/jine',{id:$id},function(data){
				//将返回来的金额传给id号为jine的标签
				$('#jine').html(data);
			});
