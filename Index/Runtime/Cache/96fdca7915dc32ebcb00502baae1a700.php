...
当前位置：<a href="/">首页</a>&nbsp;>>&nbsp;<a href="personal_index.php">个人中心</a>&nbsp;>>&nbsp;求职申请
</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="22" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4" >
            <tr>
              <td height="50" bgcolor="#F5FAFC">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:14px; color:#0033CC">求职申请</span> <span style="color: #666666">(带<strong  style="color:#FF0000">*</strong>的为必填)</span>
			...
			<form id="Form1" name="Form1" method="post" action="" ><tr>
                ...
                <td>
				<div>
				<input name="aj_name" type="text"  style="height:30px" class="input_text_200 date_input" id="start" maxlength="18" />
              ...
              <tr>
				...
				<input name="aj_post" type="text" class="input_text_200 date_input" id="endtime" maxlength="18"  style="height:30px" />
                    <span style="color:#666666"></span>
						</div>
					</td>
              </tr>
