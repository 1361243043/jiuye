...
<body>
    ...
    <div class="tools">
        ...
        <li><span><img src="__PUBLIC__/Hou/images/t04.png" /></span></li>
        </ul>
    ...
    <td>
    	<input type='checkbox' name='check[]' value="<?php echo ($vo["e_id"]); ?>" />
    </td>
    <td>
    	<img src="__PUBLIC__/Images/suo/thumb_<?php echo ($vo["e_img"]); ?>" width='50px' />
    </td>
    <td><?php echo ($vo["e_id"]); ?></td>
    <td><?php echo ($vo["e_name"]); ?></td>
    <td><?php echo ($vo["e_add"]); ?></td>
    <td><?php echo ($vo["e_intro"]); ?></td>
    <td><?php echo ($vo["e_tel"]); ?></td>
    <td><?php echo ($vo["e_mil"]); ?></td>
    <td><?php echo ($vo["e_user"]); ?></td>
    <td><?php echo ($vo["e_pwd"]); ?></td>
    <td>
    	<img src="__PUBLIC__/Hou/images/t02.png" width='10px' />
    	<a href='__URL__/update/id/<?php echo ($vo["e_id"]); ?>'>修改</a>
    </td>
    ...
    <div class="pagin">
   	...
   	<center>
    <form action='__URL__/qiye' method='post'>
    	企业:<input type='text' name='qiye' class="dfinput" style="width:80px;height:20px" />
