...
<body>
    ...
    <td>
    	<input type='checkbox' name='check[]' value="<?php echo ($vo["aj_id"]); ?>" />
    </td>
    <td><?php echo ($vo["aj_id"]); ?></td>
    <td><?php echo ($vo["aj_name"]); ?></td>
    <td><?php echo ($vo["aj_post"]); ?></td>
    <td><?php echo ($vo["aj_techang"]); ?></td>
    <td><?php echo ($vo["aj_remaks"]); ?></td>
    <td>
    	<a href='__URL__/see/id/<?php echo ($vo["aj_id"]); ?>'>&gt;&gt;更多</a>
    </td>
    ...
    <form action='' method='get'>
    	学生:<input type='text' name='name' class="dfinput" style="width:50px;height:20px" />&nbsp;&nbsp;&nbsp;&nbsp;
    	岗位:<select name='work'>
